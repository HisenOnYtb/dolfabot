...
public class ClearQueue extends ListenerAdapter {
    ...
    public void onSlashCommandInteraction(@NotNull SlashCommandInteractionEvent e) {
        ...
        if(e.getInteraction().getName().equalsIgnoreCase("cq") || e.getInteraction().getName().equalsIgnoreCase("clearqueue")){
            ...
            if(botKanal == null){ //pokud bot nikde NENÍ
                ...
                if(botKanal.equals(e.getMember().getVoiceState().getChannel())){ //pokud jsou spole ve VC
                    ...
                    stoppped.setColor(Color.ORANGE);
                    stoppped.setDescription("\uD83D\uDEAE Hráč/ka " + e.getInteraction().getMember().getAsMention() + " vymazal/a queue!");
