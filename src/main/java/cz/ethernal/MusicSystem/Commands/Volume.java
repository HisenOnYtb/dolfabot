...
public class Volume extends ListenerAdapter {
    ...
    public void onSlashCommandInteraction(@NotNull SlashCommandInteractionEvent e) {
        ...
        if(e.getInteraction().getName().equalsIgnoreCase("volume")){

            OptionMapping cislo = e.getOption("hlasitost");
            Integer volume = cislo.getAsInt();
            ...
            if(botKanal == null){ //pokud bot nikde NENÍ
                ...
                if(botKanal.equals(e.getMember().getVoiceState().getChannel())){ //pokud jsou spole ve VC
                    ...
                    channel.sendMessage("hlasitost nastavena na " + volume).queue();
