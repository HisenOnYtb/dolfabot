...
public class Lock extends ListenerAdapter {
    ...
    public void onSlashCommandInteraction(@NotNull SlashCommandInteractionEvent e) {
        ...
        if (e.getInteraction().getName().equalsIgnoreCase("voice-lock")) {
            ...
            chnl.getManager().putRolePermissionOverride(e.getGuild().getPublicRole().getIdLong(), Permission.MESSAGE_ADD_REACTION.getRawValue(), Permission.VOICE_CONNECT.getRawValue()).queue();

            EmbedBuilder hotovo = new EmbedBuilder();
            hotovo.setColor(Color.GREEN);
            hotovo.setTitle("Úspěšně jsi uzamknul/a svůj kanál!");
