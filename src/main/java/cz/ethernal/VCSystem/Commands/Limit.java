...
public class Limit extends ListenerAdapter {

    @Override
    public void onSlashCommandInteraction(@NotNull SlashCommandInteractionEvent e) {

        if(e.getInteraction().getName().equalsIgnoreCase("voice-limit")){
            ...
            OptionMapping cislo = e.getOption("počet");
            Integer number = cislo.getAsInt();
            ...
            hotovo.setTitle("Úspěšně jsi nastavil/a limit pro svůj kanál!!");
