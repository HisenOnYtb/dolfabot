...
public class Hide extends ListenerAdapter {

    @Override
    public void onSlashCommandInteraction(@NotNull SlashCommandInteractionEvent e) {

        if (e.getInteraction().getName().equalsIgnoreCase("voice-hide")) {
            ...
            chnl.getManager().putRolePermissionOverride(e.getGuild().getPublicRole().getIdLong(), Permission.MESSAGE_ADD_REACTION.getRawValue(), Permission.VIEW_CHANNEL.getRawValue()).queue();

            EmbedBuilder hotovo = new EmbedBuilder();
            hotovo.setColor(Color.GREEN);
            hotovo.setTitle("Úspěšně jsi schoval/a svůj kanál!");
