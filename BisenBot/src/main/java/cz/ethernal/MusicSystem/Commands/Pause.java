...
public class Pause extends ListenerAdapter {
    ...
    public void onSlashCommandInteraction(@NotNull SlashCommandInteractionEvent e) {
        ...
        if(e.getInteraction().getName().equalsIgnoreCase("pause")){
            ...
            if(botKanal == null){ //pokud bot nikde NENÍ
                ...
                if(botKanal.equals(e.getMember().getVoiceState().getChannel())){ //pokud jsou spole ve VC
                    ...
                    if(audioPlayer.isPaused()){
                        EmbedBuilder error = new EmbedBuilder();
                        error.setTitle("Hudba je již pozastavena!");
                        error.setColor(Color.RED);
                    ...
                    skipped.setDescription("⏸️ Hráč/ka " + e.getInteraction().getMember().getAsMention() + " pozastavil/a hudbu!");
